...
-- -----------------------------------------------------
-- Table `mydb`.`market_place`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`market_place` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `user_id` BIGINT UNSIGNED NOT NULL,
  `cart_id` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_market_place_user1_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_market_place_cart1_idx` (`cart_id` ASC) VISIBLE,
  CONSTRAINT `fk_market_place_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `mydb`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_market_place_cart1`
    FOREIGN KEY (`cart_id`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`shipment` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_shipment_address1_idx` (`address_id` ASC) VISIBLE,
